...
ticket = Ticket.create!(title: "HVAC (Air Conditioning)", description: "Hey! I just got home and it seems like the air conditioning system stopped working, could you please check up on it?", status: "pending", priority: "Low", room_id: usertenant4.room.id)
ticket.photos.attach(io: file, filename: "nes.png", content_type: "image/png")
ticket.save
